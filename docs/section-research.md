...
Every single concept extended the WebPart idea, which allowed to match all the building blocks into one consistent whole, in a natural for functional programming manner.
