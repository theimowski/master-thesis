...
\usepackage[top=2.5cm,bottom=2.5cm,left=3.5cm,right=2.5cm,asymmetric,twoside=true]{geometry}
\usepackage{helvet}
...
\addto{\captionsenglish}{\renewcommand{\refname}
    {\normalfont\fontsize{12}{15}\bfseries{BIBLIOGRAPHY}}}

\addto{\captionsenglish}{\renewcommand{\contentsname}
    {\normalfont\fontsize{12}{15}\bfseries{TABLE OF CONTENTS}}}
...
\includepdf[pages={1}]{Oswiadczenie_131517_pl.pdf}

\include{abstract}
\selectlanguage{polish}
\include{streszczenie}
\include{streszczenie2}
